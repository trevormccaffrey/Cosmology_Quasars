...
ufil = pd.read_csv("SDSS_Filters/u.txt", sep="\s+").values
gfil = pd.read_csv("SDSS_Filters/g.txt", sep="\s+").values
rfil = pd.read_csv("SDSS_Filters/r.txt", sep="\s+").values
ifil = pd.read_csv("SDSS_Filters/i.txt", sep="\s+").values
zfil = pd.read_csv("SDSS_Filters/z.txt", sep="\s+").values
vb01 = pd.read_csv("vandenberk01_medianSDSSspectrum.txt", sep="\s+").values
